...
class RESTRequestButton extends Component<{}, { buttonText: string, buttonIcon: string, statusColor: string, message: string | undefined, responseBody: string | undefined}> {
                    ...
                    .then(
                        async (response) => {
                            ...
                            if (response.status >= 200 && response.status < 300)
                                ...
                                if (SDK.getConfiguration().witInputs["ShowErrorAlertBox"].toLowerCase() == "true")
                                    alert(`${responseText}`)
                            }
                            ...
                            if (response.body !== null){
                                ...
                                this.setState({
                                    responseBody: SDK.getConfiguration().witInputs["ShowResponseBody"].toLowerCase() != "false" ? responseText : ""
                                })
                            }
                        },
                        (error: Error) => {
    ...
    private async buildConfiguration(body: object) : Promise<RequestInit> {
        ...
        else if (shouldUseDefaultBearer.toLowerCase() != "false")
